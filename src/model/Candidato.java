...
public class Candidato {
	...
	public String toString() {
		return "Candidato [id=" + id + ", nome=" + nome + ", ensinoMedioPublico=" + ensinoMedioPublico
				+ ", ensinoSuperiorCompleto=" + ensinoSuperiorCompleto + ", anosRegistroEntidadeClasse="
				+ anosRegistroEntidadeClasse + ", anosExperiencia=" + anosExperiencia + ", pontosProva=" + pontosProva
				+ "]";
	}
